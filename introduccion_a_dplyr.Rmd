...
Para ilustrar el uso del paquete vamos a usar los datos contenidos en el archivo `r xfun::embed_file("./data/pesada_terneros.xlsx", text = "pesada_terneros.xlsx")`. Para más detalles ir a la hoja de descripción de datos.
