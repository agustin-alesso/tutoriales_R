...
```{r, echo = F, fig.cap = 'Página oficial de R Project', out.width = '70%', fig.align = 'center', fig.pos= 'h', out.extra=''} 
#knitr::include_graphics('images/rproject.png', auto_pdf = T)
webshot::webshot('http://www.r-project.org', file = "./images/rproject.png")
```
